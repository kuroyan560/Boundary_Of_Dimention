...
{
	ENEMY_ATTACK_PATTERN_NORMAL,//ƒvƒŒƒCƒ„[‚ğŒ©‚Â‚¯‚½‚çUŒ‚ŠJn
	ENEMY_ATTACK_PATTERN_ALWAYS, //í‚Éˆê’èŠÔŠu‚ÅUŒ‚‚µ‚Ä‚¢‚é
...
{
	ENEMY_BARREL_PATTERN_FIXED,		//•ûŒüŒÅ’è
	ENEMY_BARREL_PATTERN_ROCKON,	//ƒvƒŒƒCƒ„[‚ÉŒü‚©‚Á‚Ä
...
public:
	...
	private:
		...
		bool m_appearFlag;			//“oê
		bool m_showEffectFlag;		//‰½‚ª‹N‚«‚½‚Ì‚©‚µ‚Á‚©‚èŒ©‚¹‚é
		bool m_preDissappearFlag;	//Á‚¦‚é€”õ
		bool m_disappearFlag;		//Á–Å
