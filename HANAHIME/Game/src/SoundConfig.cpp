...
SoundConfig::SoundConfig()
{
	...
	m_seTable[SE_ZIP_LINE_GET_ON].Load(audioApp->LoadAudio(seDir + "ivy_zip_line_on.wav"));
	m_seTable[SE_ZIP_LINE_GET_OFF].Load(audioApp->LoadAudio(seDir + "ivy_zip_line_off.wav"));
